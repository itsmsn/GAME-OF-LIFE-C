...
void myRect(int x1, int y1, int x2, int y2, COLORREF lineColor, COLORREF fillColor)
{
	...
	Rectangle(device_context, x1 + 650, y1, x2 + 650, y2);
	DeleteObject(pen);
	DeleteObject(brush);
	ReleaseDC(console_handle, device_context);
}
	...
	for (int i = 0; i < size; i++)
	{
		for (int j = 0; j < size; j++)
		{
			...
			if (arr[j][i] == 20) {
				...
				for (int a = 0;a < 10;a++)
				{
					myRect(i * 45, j * 45, (i * 45) + 45, (j * 45) + 45, RGB(0, 0, 0), RGB(255,0,0));
				}
			}
			else if (arr[j][i] == 25) {
				//x = ((i * 45) + ((i * 45) + 45));
				for (int a = 0; a < 10; a++)
				{
					myRect(i * 45, j * 45, (i * 45) + 45, (j * 45) + 45, RGB(0, 0, 0), RGB(3, 22, 166));
				}
			}
			else if (arr[j][i] == 15) {
				//x = ((i * 45) + ((i * 45) + 45));
				for (int a = 0; a < 10; a++)
				{
					myRect(i * 45, j * 45, (i * 45) + 45, (j * 45) + 45, RGB(0, 0,0), RGB(0, 163, 49));
				}
			}
			else if (arr[j][i] == 30) {
				//x = ((i * 45) + ((i * 45) + 45));
				for (int a = 0; a < 10; a++)
				{
					myEllipse(i * 45, j * 45, (i * 45) + 45, (j * 45) + 45, RGB(0,0,0), RGB(255,255, 0));
				}
			}
			else if (arr[j][i] == 31) {
				//x = ((i * 45) + ((i * 45) + 45));
				for (int a = 0; a < 10; a++)
				{
					myEllipse(i * 45, j * 45, (i * 45) + 45, (j * 45) + 45, RGB(0, 0,0), RGB(255, 255, 255));
				}
			}
		}
	}
